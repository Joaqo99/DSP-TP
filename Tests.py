...
print(f"Estimado TDOA: {estimated_tdoa:.6f} s")
print(f"Ángulo estimado: {estimated_theta_deg:.2f}°")
...
plot.plot_signal(mic1_dict, mic2_dict,title=f"Señales en micrófonos (θ = {theta_deg}°)", grid=True, legend=True, figsize=(10, 4),
